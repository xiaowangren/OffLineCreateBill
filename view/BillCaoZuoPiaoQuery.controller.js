...
// 		sap.ui.getCore().setModel(oLocalModel);
    ...
    onCaoZuoPiaoQuery1:function(){
        ...
        var oData1 = sap.ui.controller("com.zhenergy.bill.view.BillOverLookPage").onReadIDB(function(oData1){
			for(var i=0;i<oData1.length;i++){
                if(oController.checkhelp(oData1[i].Iwerk,gongChangQueryId)&&
                   oController.checkhelp(oData1[i].Ztype,caoZuoPiaoLeiXingQuery)&&
                   oController.checkhelp(oData1[i].Prfty,zhuanYeQueryStart)&&
                   oController.checkhelp(oData1[i].Cdata,kaiPiaoRiQiQueryStart)&&
                   oController.checkhelp(oData1[i].Cuser,kaiPiaoRenQuery)&&
                   oController.checkhelpIndex(oData1[i].Ztask,caoZuoRenWuQuery)
                   ){
